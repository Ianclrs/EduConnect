...
7. **AC7:** Notificações automáticas ao detectar documentos pendentes/vencidos (integrado com Spec 7).
...
- Spec 1, 2, 3, 4 (precisa de auth, alunos, pais)
- Spec 7 (documentos — para notificações automáticas)
